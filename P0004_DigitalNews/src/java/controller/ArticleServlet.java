...
public class ArticleServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Article atcRequest = null;
            String id = request.getParameter("id");
            
            if(id == null){
                atcRequest = atcMostRecent;
            }
            else atcRequest = atcDAO.getArticleByID(Integer.valueOf(id));
                
            atcRequest.setContent(atcRequest.getContent().replaceAll("\\n", "</p><p>"));
            
            request.setAttribute("mostRecentNew", atcMostRecent.getDescription());
            request.setAttribute("top5News", top5News);
            request.setAttribute("article", atcRequest);
